...
const Login = () => {
  ...
  // Added debugging logs to identify the issue with the loading state and login logic.
  const onSubmit = async (data) => {
    ...
    try {
      ...
      console.log("Resetting form and loading state");
      reset();
      setIsLoading(false);
    }
  };
    ...
    <div className="login-wrapper">
      <div className="login-panel">
        ...
        >
          ...
          >
            Book appointments, track services, and receive personalized dental
            care — all in one portal.
          </motion.p>
          <motion.img
